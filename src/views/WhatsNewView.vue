  ...
  <div id="view-container">
    ...
    <section>
      <div>
        ...
        <p>
          Everyone is invited! We will watch a small documentary about the history of the church.
          Also we will have guest speakers and testimonies about God's work in the past 10 years.
        </p>
      </div>
      <div class="icon-row">
        <v-icon
